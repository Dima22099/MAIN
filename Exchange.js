...
function handleClickLeft(event) {
    ...
    if (event.target.classList.contains('currency-checked') && !event.target.classList.contains('left__arrow__down')) {
        return;
...
function handleClickRight(event) {
    ...
    if (event.target.classList.contains('currency-checked') && !event.target.classList.contains('right__arrow__down')) {
        return;
